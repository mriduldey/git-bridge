...
RepoFerry supports multiple repository providers and multiple repository sources.
...
This ADR defines the transport abstraction used throughout RepoFerry.
...
RepoFerry adopts a **Transport Abstraction with a Middleware Pipeline**.
...
RepoFerry adopts a layered transport architecture.
...
RepoFerry executes every transport request through a middleware pipeline.
...
RepoFerry adopts a **Pipeline / Chain of Responsibility** architecture.
...
RepoFerry includes several built-in middleware components.
...
RepoFerry supports cooperative cancellation.
...
RepoFerry supports Local, ZIP, and future repository sources.
...
This ADR defines the Transport subsystem of RepoFerry.
...
ADR-007 establishes the Transport architecture of RepoFerry.
...
This architecture enables RepoFerry to support HTTP, Local File System, ZIP archives, in-memory repositories, and future transport mechanisms through a single, stable abstraction while preserving the provider-neutral design established in previous ADRs.