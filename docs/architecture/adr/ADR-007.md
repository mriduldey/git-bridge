...
GitBridge supports multiple repository providers and multiple repository sources.
...
This ADR defines the transport abstraction used throughout GitBridge.
...
GitBridge adopts a **Transport Abstraction with a Middleware Pipeline**.
...
GitBridge adopts a layered transport architecture.
...
GitBridge executes every transport request through a middleware pipeline.
...
GitBridge adopts a **Pipeline / Chain of Responsibility** architecture.
...
GitBridge includes several built-in middleware components.
...
GitBridge supports cooperative cancellation.
...
GitBridge supports Local, ZIP, and future repository sources.
...
This ADR defines the Transport subsystem of GitBridge.
...
ADR-007 establishes the Transport architecture of GitBridge.
...
This architecture enables GitBridge to support HTTP, Local File System, ZIP archives, in-memory repositories, and future transport mechanisms through a single, stable abstraction while preserving the provider-neutral design established in previous ADRs.