...
The TypeScript type system is part of GitBridge's public API.
...
GitBridge adopts a **provider-neutral, immutable, interface-first type system**.
...
GitBridge defines provider-neutral value models.
...
GitBridge favors semantic aliases over branded types.
...
GitBridge prefers **string literal unions** over runtime enums.
...
Would permanently couple GitBridge to provider implementations.

---

# 26. References

This ADR defines the public type system of GitBridge.
...
ADR-011 establishes the public type system of GitBridge.
