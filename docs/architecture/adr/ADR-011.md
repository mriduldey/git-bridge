...
The TypeScript type system is part of SourceAxis's public API.
...
SourceAxis adopts a **provider-neutral, immutable, interface-first type system**.
...
SourceAxis defines provider-neutral value models.
...
SourceAxis favors semantic aliases over branded types.
...
SourceAxis prefers **string literal unions** over runtime enums.
...
Would permanently couple SourceAxis to provider implementations.

---

# 26. References

This ADR defines the public type system of SourceAxis.
...
ADR-011 establishes the public type system of SourceAxis.
